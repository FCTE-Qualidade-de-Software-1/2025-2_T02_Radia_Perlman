...
|                         |                                                                               | **M4.2: Facilidade de Migração**                               | Testes de Migração                | 1. X1.  = A/B. Aceitação ≥ 0.9.                                                                                 | CT-P-Q4-M2         |
...
| **Fase 3**    | Coleta Adequação Funcional              | **M1.1** Completude de Tarefas <br> **M2.1** Precisão do Feedback <br> **M2.2** Integridade de Dados <br> **M3.1** Recuperação de Informação <br> **M3.2** Adequação Funcional (Likert)                                                                                                                                | [Bianca Patrocínio](https://github.com/BiancaPatrocinio7) <br> [Douglas Marinho](https://github.com/M4RINH0)                                                   | **21/11/25**        | **23/11/25**     |
